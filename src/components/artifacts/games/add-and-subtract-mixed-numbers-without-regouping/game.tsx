...
export default function MixedFractionGame({sendAdminMessage}: GameProps) {
  ...
  return (
    <div className="mx-auto game-container font-jersey">
      <DevHelper />
      {/* Game screens */}
      ...
      <style jsx global>{`
        @import url('https://fonts.googleapis.com/css2?family=Jersey+25&family=Jost:ital,wght@0,100..900;1,100..900&display=swap');
        .font-jersey {
