...
import redbar from '../../assets/red-key-bar.png'
import yellowsinglebar from '../../assets/yellow-single-bar.png'
import downbanner1 from '../../assets/attempt-failed-bg.png'
import downbanner2 from '../../assets/down-banner.png';
import Hammer from '../../assets/hammer.png'
import { getIfColored } from '../../components/commonFunctions';


export default function Screen3Step5({ sendAdminMessage }: BaseProps) {
  ...
  return (
    <div className="mx-auto min-h-screen overflow-hidden" style={{ backgroundImage: `url(${background.src})`, backgroundSize: '100% 100%' }}>
              ...
              >
                {Array.from({ length: 10 }, (_, j) => (
                  getIfColored(i, j, a, b, n) && (
                    <img
                      key={`cell-${i}-${j}`}
                      className='w-[1.72vh] h-auto select-none'
      ...
      {!onHammer ? <div style={{ backgroundImage: `url(${downbanner1.src})`, backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' }}
        ...
        <div style={{ backgroundImage: `url(${downbanner2.src})`, backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' }}
