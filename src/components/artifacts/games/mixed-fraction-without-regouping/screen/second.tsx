...
const Step1 = () => {
  ...
  return (
    <div className="flex gap-8 flex-col w-full scale-125 origin-top">
      <Intro text="Lets us do another question now! You can do this." />
      <div className="w-full max-w-3xl mx-auto">
        <div className="bg-lime-200 py-2 mb-[2px] text-2xl border-2 font-extrabold border-gray-800 px-4 rounded-t-lg text-center">
          Total Order
        </div>
...
const Step2 = () => {
  ...
  return(
    <div className='flex flex-col gap-4 w-full my-16 items-center'>
      { substep >= 0 &&
          <QuestionDescription whole={fraction1.whole} numerator={fraction1.numerator} denominator={fraction1.denominator} pizzaName='pepperoni' color='pink' onComplete={() => setSubStep(1)} />
      }
      { substep >= 1 &&
          <QuestionDescription whole={fraction2.whole} numerator={fraction2.numerator} denominator={fraction2.denominator} pizzaName='cheese' color='yellow' onComplete={() => setSubStep(2)} />
      }
      { substep >= 2 &&
        <CombineFractionInput onComplete={() => setSubStep(4)} fraction1={fraction1} fraction2={fraction2} />
      }
      { substep >= 4 &&
...
export const CombineFractionInput = ({ onComplete, fraction1, fraction2 }: { onComplete: () => void, fraction1: MixedFractionProps, fraction2: MixedFractionProps }) => {
