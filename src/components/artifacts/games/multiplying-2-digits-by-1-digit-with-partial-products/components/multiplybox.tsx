      ...
      <div className="flex w-[50vh]">
        <div className={`flex flex-col items-center justify-start ${transition ? 'transition-all duration-1000 opacity-100' : 'opacity-0 translate-x-[25vh]'}`}>
          ...
          >
            ...
            {nextStep && <div className={`relative h-full flex flex-col items-center justify-start translate-x-[${number2 * 10}vh] z-20`}
              style={{
            ...
            {isDragging && <div className={`absolute z-20 -translate-y-[16vh] transition-all duration-1000 ${transition ? 'opacity-100 translate-x-[1.5vh]' : 'opacity-0 translate-x-[10vh]'}`}>
