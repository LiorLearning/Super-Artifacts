  ...
  return (
    <div className="realtive bg-[#B9F7FF] min-h-screen overflow-hidden flex justify-center items-end">
      ...
      <div className="absolute z-20 translate-x-[6vw] -translate-y-[10vh]">
        <MultiplyBox number1={number1} number2={number2}  defaultSilderValue={number1%10} short={true} onCorrect={onCorrect} fixColorNotRed={true} stepSum={true} sendAdminMessage={sendAdminMessage}/>
      </div>
