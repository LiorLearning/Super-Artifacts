...
import MultiplyBox2 from "../../components/multiplybox2";

interface Screen1Step2Props extends BaseProps {
  ...
  export default function Screen1Step2({sendAdminMessage, horizontalSliderValue, setHorizontalSliderValue, verticalSliderValue, setVerticalSliderValue}: Screen1Step2Props) {
