...
interface Screen2Step2Props extends BaseProps {
  ...
  export default function Screen2Step2({sendAdminMessage, horizontalSliderValue, setHorizontalSliderValue, verticalSliderValue, setVerticalSliderValue}: Screen2Step2Props) {
