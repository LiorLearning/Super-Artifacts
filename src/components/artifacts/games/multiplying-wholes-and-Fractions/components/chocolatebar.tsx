  ...
  return (
    <div className="flex max-w-screen-md my-4 mx-auto w-[60%] relative -space-x-[3px] min-w-52">
      ...
      <div className="absolute -top-3 left-full flex flex-col gap-4 px-8 items-end">
        ...
        <Button
          id="join-button"
          className={`${active ? 'bg-[#fef149] hover:bg-[#fef149]/80' : 'bg-red-100 hover:bg-red-100/80'} text-black text-2xl  px-4 py-2 flex items-center rounded-sm gap-2 shadow-[-3px_3px_0px_0px_rgba(0,0,0)] ${denominator === 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
          onClick={() => {
          if (denominator === 1) {
            return;
          }
