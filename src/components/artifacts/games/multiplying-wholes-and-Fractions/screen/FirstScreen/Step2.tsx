...
export default function Screen1Step2() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <FractionHeader level={1} whole={wholes.whole} numerator={fraction.numerator} denominator={fraction.denominator} />
      ...
      <div className="my-12 bg-[#fff0e5] p-10">
        <div className="flex justify-center items-center gap-4 text-4xl text-black">
          ...
          <div>Pieces</div>
          <div className="p-2 px-4 bg-white border-2 border-black rounded-md">{fraction.numerator * wholes.whole}</div>
          <div>times</div>
        </div>

        <div className="display flex justify-center items-center gap-6 text-black text-4xl leading-none mx-auto my-10">
          <div className="flex text-center">{fraction.numerator * wholes.whole} times</div>
          ...
          <div>=</div>
          {bar === fraction.numerator * wholes.whole ? <div className="flex flex-col items-center justify-center bg-white border-4 border-[#b9550b] px-4 leading-none">
            <div className="p-2 border-b-2 border-black">{fraction.numerator * wholes.whole}</div>
            <div className="p-2">{fraction.denominator}</div>
          </div> :
          <div className="flex flex-col items-center justify-center bg-white border-4 border-[#b9550b] px-4 leading-none">
      ...
      {bar != fraction.numerator * wholes.whole && <div className="mx-auto shadow-[-3px_3px_0px_0px_rgba(0,0,0)] bg-[#b9550b] p-6 leading-none text-4xl text-white text-center my-8">
        LISTEN TO THE HINT 🔊
      </div>}

      {bar === fraction.numerator * wholes.whole && <SuccessAnimation />}
